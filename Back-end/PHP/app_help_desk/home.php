        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <?php if ($row->perfil != 'Adm' && $row->perfil != 'Tec') { ?>
                <div class="col-2 d-flex justify-content-center">
                  <a href="#" style="filter: grayscale(100%); opacity: 0.5;">
                    <img src="editar.png" width="70" height="70">
                    <p>&nbspEditar</p>
                  </a>
                </div>
                ...
                <div class="col-2 d-flex justify-content-center">
                <a href="#" style="filter: grayscale(100%); opacity: 0.5;">
                  <img src="autorizar.png" width="70" height="70">
                  <p>Autorizar</p>
                </a>
              </div>
              ...
              <div class="col-2 d-flex justify-content-center">
                <a href="#" style="filter: grayscale(100%); opacity: 0.5;">
                  <img src="usuario.png" width="70" height="70">
                  <p>&nbspUsuários</p>
                </a>
              </div>
              ...
              <div class="col-2 d-flex justify-content-center">
                <a href="#" style="filter: grayscale(100%); opacity: 0.5;">
                  <img src="relatorio.png" width="70" height="70">
                  <p>Relatórios</p>
                </a>
              </div>
